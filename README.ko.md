...
<p align="center">
  ...
  <img alt="version 0.2.0" src="https://img.shields.io/badge/version-0.2.0-d97757">
...
- **Chromium은 모든 줄을 한 글자 텍스트 객체로 쪼갠다.** 조각 하나를 고치면 옆과 겹치므로, UI가 기준선과 인접성으로 객체를 한 줄로 묶어 새 글을 첫 조각에 넣고 나머지를 비웁니다.
